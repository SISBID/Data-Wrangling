...
6. You can now use rvest to scrape [bioc-software.html](https://raw.githubusercontent.com/SISBID/Module1/gh-pages/labs/bioc-software.html) just as we did in class (hint: the xpath is `//*[@id="biocViews_package_table"]`). 
