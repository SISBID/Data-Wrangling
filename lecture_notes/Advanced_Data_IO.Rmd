...
# Google Sheets<br>https://jhudatascience.org/tidyversecourse/get-data.html#google-sheets
...
## Browse sheets in your Google Drive, descending by date

Use the `gs4_find()` function, coupled with `drive_auth()` credentials:

```{r}
googledrive::drive_auth(email = "avamariehoffman@gmail.com")
head(gs4_find(),1)
```
