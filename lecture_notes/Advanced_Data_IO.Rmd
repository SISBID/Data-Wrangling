...
# Do the following if you need to re-prompt the browser popup!
gs_auth(new_user = TRUE)
out = read_sheet(sheets_url)
```

## Can also save and load a token (might not work with RStudio Cloud)

```{r, message = FALSE}
# Do this once
# Always make sure to .gitignore your token file!
token_in = "your-token-hash-here"
readr::write_rds(token_in, file = "googledrive_token.rds")
```
