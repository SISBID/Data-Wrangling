...
* Open R Studio
* Files --> New --> R Script
* Save the blank R script as "day2.R" in a directory of your choosing
...
2. Close RStudio Double click `day2.R`

* Confirm the directory contains "day2.R" using `dir()`:
    * Type `dir()` in the R Console (`day2.R` should be there)    
...
Add a comment header to day2.R :`#` is the comment symbol
