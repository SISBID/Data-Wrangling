...
3. How accurate is the (formerly-named) `duration (seconds)` column? I.e. how many of the  minutes-scale observations (assuming "min" is the pattern to look for) have durations greater than 14400 seconds (or 4 hours)? 
