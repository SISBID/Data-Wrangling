...
https://sisbid.github.io/Data-Wrangling/12_Data_Merging/lab/merging-lab.Rmd
...
`?dplyr::setops` also has lots of functions for performing set operations using the rows of a data frame instead of vectors (including `intersect`, `union`, `setdiff`, etc.)
