...
# Pivoting `count` tibbles

## Pivoting `count` tibbles {.codesmall}

Creating pivots of two variables
...
Creating pivots of two variables - sample size ("n")
...
https://sisbid.github.io/Data-Wrangling/11_Data_Reshaping/lab/data-reshaping-lab.Rmd
